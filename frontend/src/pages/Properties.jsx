...
async function fetchProperties(token) {
  const response = await axios.get("https://room-lock-management-eqw4.vercel.app/properties", {
...
const Properties = () => {
  ...
  const deletePropertyMutation = useMutation({
    mutationFn: async (propertyId) => {
      await axios.delete(`https://room-lock-management-eqw4.vercel.app/properties/${propertyId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
    },
    onSuccess: () => {
